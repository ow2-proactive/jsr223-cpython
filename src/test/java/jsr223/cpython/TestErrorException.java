...
public class TestErrorException {
    ...
    public void testError() throws Exception {
        ...
        String pythonScript = "greeting = \"hello\" + \" world\n" + "print('" + messageAfter + "')\n";
        ...
        Assert.assertNotNull("The script error must not be null", res.getException());
        Assert.assertTrue("The script error must contain the error statement",
    ...
    public void testException() throws Exception {
        ...
        Assert.assertTrue("The script output must contain the error statement",
                          output.toString().contains("Invalid level"));
